...
class CouponIssueRedisServiceTest extends TestConfig {
    ...
    @Test
    @DisplayName("쿠폰 수량 검증 - 발급 가능한 수량이 존재하면 true를 반환한다.")
    void availableTotalIssueQuantity_1() throws Exception {
        // given
    ...
    @Test
    @DisplayName("쿠폰 수량 검증 - 발급 가능한 수량이 모두 소진되면 false를 반환한다.")
    void availableTotalIssueQuantity_2() throws Exception {
        // given
        int totalIssueQuantity = 10;
        long couponId = 1;
    ...
    void availableUserIssueQuantity_1() throws Exception {
        // given
        long couponId = 1;
        long userId = 1;
    ...
    void availableUserIssueQuantity_2() throws Exception {
        // given
        long couponId = 1;
        long userId = 1;
        redisTemplate.opsForSet().add(getIssueRequestKey(couponId), String.valueOf(userId));
